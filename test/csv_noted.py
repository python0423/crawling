...
# @Last Modified time: 2018-03-19 12:20:11
...
def writen_bask(f_obj,row):
	# 获取到传入的文本列表，然后写入csv文件中
    with open(f_obj,"a+") as csvfile:
        u_csv=UnicodeWriter(csvfile,encoding="utf-8",delimiter=",")
        u_csv.writerow(row)
        # u_csv.writerow("\r\n")
    return 
